...
from app.features.invitations.use_cases.accept_invitation import AcceptInvitationUseCase
from app.features.invitations.use_cases.revoke_invitation import RevokeInvitationUseCase
from app.features.invitations.use_cases.list_project_pending_invitations import ListProjectPendingInvitationsUseCase
...
def get_list_project_pending_invitations_use_case(
    invitation_repository = Depends(get_invitation_repository)
):
    return ListProjectPendingInvitationsUseCase(invitation_repository)